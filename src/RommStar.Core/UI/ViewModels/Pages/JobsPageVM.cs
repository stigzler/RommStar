...
namespace RommStar.Core.UI.ViewModels.Pages
{
    public partial class JobsPageVM : ObservableObject
    {
        ...
        {
            //_syncManager?.EnqueuePlatformSync("Atari 2600", new List<int>() { 1, 2, 4 }, false);
            //_syncManager?.EnqueuePlatformSync("Dave 2000", new List<int>() { 7, 9, 11 }, false);
            //_syncManager?.EnqueuePlatformSync("Amiga 7000", new List<int>() { 13, 19, 32 }, false);
        }

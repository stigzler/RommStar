...
namespace RommStar
{
    ...
    /// <summary>
    /// Steam Storefront Model: Dictates which asset streams are pulled
    /// during a specific runtime operation.
    /// </summary>
    ...
    public class PlatformSyncTask
    {
        ...
        public List<int> RommPlatformIds { get; set; }
        public bool DownloadRomFiles { get; set; }
        public PlatformSyncJob UiCard { get; set; }
    ...
    public class DownloadJob
    {
        ...
        public string LaunchBoxPlatformName { get; set; }
        public RommServerConfig ServerContext { get; set; }
    ...
    // Placeholder Data Transfer Object mapping Romm's /api/roms response layout
    public class RomDto
    {
    ...
    public class RommService
    {
        ...
        // Steam Profiles configuration sets
        ...
        public async Task ExecuteOnDemandInstallAsync(string lbPlatform, RomDto rom)
        {
            ...
            // 1. Instantly pull down down the critical ROM execution payload on a dedicated task lane
